...
export const skillsData = {
  languages: [
    { name: "JavaScript (ES6+)", level: 92, category: "Core Language" },
    { name: "Java", level: 82, category: "Object-Oriented" },
    { name: "C++", level: 78, category: "Algorithms & DS" },
    { name: "C", level: 75, category: "System Concepts" }
  ],
  frontend: [
    { name: "React.js", level: 92, category: "Modern SPA & SSR" },
    { name: "Next.js", level: 88, category: "App Router & Full-Stack" },
    { name: "Tailwind CSS", level: 95, category: "Responsive Styling" },
    { name: "HTML5 & CSS3", level: 95, category: "Semantic Markup" },
    { name: "Bootstrap", level: 85, category: "Rapid Prototyping" }
  ],
  backend: [
    { name: "Node.js", level: 88, category: "Runtime Environment" },
    { name: "Express.js", level: 92, category: "RESTful Web Server" },
    { name: "RESTful API Architecture", level: 92, category: "Middleware & Routing" },
    { name: "EJS Server-Side Rendering", level: 86, category: "Dynamic Templates" },
    { name: "JWT & Bcrypt Security", level: 90, category: "Auth & Encryption" }
  ],
  database: [
    { name: "MongoDB", level: 90, category: "NoSQL Database" },
    { name: "Mongoose ODM", level: 92, category: "Schema & Validation" },
    { name: "MySQL", level: 80, category: "Relational Queries" },
    { name: "Indexing & Performance", level: 86, category: "Query Optimization" }
  ],
  tools: [
    { name: "Git & GitHub", level: 92, category: "Version Control" },
    { name: "VS Code", level: 95, category: "Development IDE" },
    { name: "Postman", level: 90, category: "API Testing" },
    { name: "Cloudinary & Multer", level: 88, category: "CDN Media Pipelines" }
  ]
};
...
export const projectsData = [
  {
    id: "travelnest",
    title: "TravelNest",
    subtitle: "Full-Stack Travel & Accommodation Marketplace",
    category: "Full Stack (Node/Express + MongoDB + SSR)",
    badge: "Featured Full-Stack",
    status: "Live & Deployed",
    featured: true,
    github: "https://github.com/MrVinayakGupta",
    live: "https://github.com/MrVinayakGupta", // Direct live demo link
    liveUrl: "https://github.com/MrVinayakGupta",
    metrics: [
      { label: "Lighthouse Score", val: "98/100" },
      { label: "Server Latency", val: "-20% Reduced" },
      { label: "Query Speed", val: "+35% Faster" }
    ],
    tech: ["Node.js", "Express.js", "MongoDB", "EJS SSR", "REST API", "Async Middleware", "Session Auth", "Bootstrap"],
    summary: "A production-grade travel accommodation marketplace featuring verified listings, protected user reservations, and instant review aggregation.",
    highlights: [
  ...
  },
  {
    id: "pinspire",
    title: "Pinspire",
    subtitle: "Full-Stack Photo Management & Visual Discovery Platform",
    ...
    metrics: [
      ...
      { label: "Security Index", val: "+30% Boost" },
      { label: "Render Redundancy", val: "-15% Cut" }
    ],
...
export const educationData = [
  {
    ...
    description: "Coursework in Data Structures & Algorithms, Object-Oriented Programming (Java/C++), Database Management Systems (SQL/NoSQL), Web Technologies, and Operating Systems.",
    highlight: "Computer Science & Application Software"
  },
  {
...
export const terminalCommands = {
  ...
  • about       : Bio & developer profile summary
  • skills      : Core competencies & tech matrix
  • projects    : Highlighted full-stack applications
  • education   : Academic journey & degrees
  • certs       : Verified certificates (Apna College Delta & Scaler)
...
Location: Jaunpur, Uttar Pradesh, India
BCA Scholar (VBS Purvanchal University, 2023-2026)
Specializing in high-performance React frontends & resilient Node/Express backends.`,

  skills: `Frontend : React.js, Next.js, Tailwind CSS, Bootstrap, HTML5, CSS3, JavaScript
